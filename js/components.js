    ...
    template:`
            <div>
                ...
                <div class="container row">
                    <div v-for="(artist, index) in musicOfArtist.data" class="col s4 card">
                        <div class="card-image waves-effect waves-block waves-light">
                            <img class="activator" v-bind:src="musicOfArtist.data.artist.album.cover_big">
                        </div>
    ...
    template:`
        <section>
            <div>
                ...
                <!--<button v-on:click="check()">clique</button>-->
            </div>
