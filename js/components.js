				...
				<ul class="collection with-header">
					...
					<div v-for="(track,index) in trackList">
						...
						<router-link	:class="{'active' : $route.name === 'titlePageComponent.template'}" 
										:to="{name: 'trackPage', params:{ requestData:requestData, trackTitle:track.title, trackLink:track.link, trackPreview:track.preview, albumPic:$route.params.albumCover, albumHeader:$route.params.albumTitle, artistPic:$route.params.artistImg, artistNom:$route.params.artistName}}">
